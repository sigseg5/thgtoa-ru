...
-   [Основы понимания того, как некоторая информация может привести к вам и как смягчить последствия:][Understanding some basics of how some information can lead back to you and how to mitigate some:]
    ...
    -   [Вредоносные программы, эксплоиты и вирусы:]
        -   [Вредоносные программы в ваших файлах/документах/электронной почте:]
...
-   Правительственные агентства по всему миру, заинтересованные в вашем номере телефона, могут использовать и используют[^82] специальные устройства, называемые "ловцы IMSI"[^83], такие как Stingray[^84] или недавно появившийся Nyxcell[^85]. Эти устройства выдают себя за базовую станцию оператора и заставляют телефон, с определённым IMSI (ваш телефон), подключиться к ней для доступа к сети. После этого они смогут использовать различные MITM[^86] (Man-In-The-Middle Attacks), которые позволят им:
    ...
    -   Перехват и анализ интернет-трафика
...
Вот несколько ресурсов, с помощью которых можно попробовать сделать это самостоятельно:
...
-   Вы никогда не должны на 100% доверять приложениям, которые вы используете.
...
Вот результат с изображения выше:
...
И на это есть причины[^215]'[^216]'[^217]:
...
-   SegWit адрес: ```bc1qtall24j005qsd3dw8wahxhvged4vepn9fjp3my```

-   Legacy адрес: ```17jYYV1x92fm9EVDbHuQjS5t9Qc44533Jw```
...
[^432]: Tor Browser Manual, Pluggable Transport <https://tb-manual.torproject.org/circumvention/> <sup>[[Archive.org]][972]</sup>
  ...
  [Ваши DNS запросы:]: #your-dns-requests
  ...
  [Ваш анонимизированный трафик через Tor/VPN:]: #your-anonymized-torvpn-traffic
  [Some Devices can be tracked even when offline:]: #some-devices-can-be-tracked-even-when-offline
  [Идентификаторы вашего оборудования:]: #your-hardware-identifiers
  [Ваши IMEI и IMSI (а также ваш номер телефона):]: #your-imei-and-imsi-and-by-extension-your-phone-number
  ...
  [Ваши умные устройства в целом:]: #your-smart-devices-in-general
  [Yourself:]: #yourself
  [Ваши метаданные, включая ваше местоположение:]: #your-metadata-including-your-geo-location
  [Ваши цифровые отпечатки и поведение в сети:]: #your-digital-fingerprint-footprint-and-online-behavior
  [[Подсказки для вашей реальной жизни и OSINT:]]: #your-clues-about-your-real-life-and-osint
  ...
  [Ваши файлы, документы, изображения и видео:]: #your-files-documents-pictures-and-videos
  [Properties and Metadata:]: #properties-and-metadata
  [Watermarking:]: #watermarking
  [Пикселизированная или размытая информация:]: #pixelized-or-blurred-information
  ...
  [Локальные утечки данных и форензика:]: #local-data-leaks-and-forensics
  [Плохая криптография:]: #bad-cryptography
